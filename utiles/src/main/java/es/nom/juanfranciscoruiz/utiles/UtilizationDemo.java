...
public class UtilizationDemo {
   ...
   */
  public final static Logger logger = LoggerFactory.getLogger(UtilizationDemo.class);
  ...
  public static void main(String[] args) {
    //TODO: Do the demos through all the objects of the library implemented in methods of this class
