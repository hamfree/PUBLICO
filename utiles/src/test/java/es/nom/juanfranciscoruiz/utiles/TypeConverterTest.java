...
public class TypeConverterTest {
    ...
    public void testMap2List() {
        ...
        Map<String, Object> mapToConvert = new LinkedHashMap<>();
        List<Integer> expectedValue = new ArrayList<>();
        List<Integer> actualValue;
        Class<Integer> clazz;
    ...
    public void testExtractLongFromString() {
        ...
        assertAll(
                ...
                () -> {
                    ...
                    dbg(logger, "TypeConverterException : {}", ex.getMessage());
                },
                () -> {
                    TypeConverterException ex = assertThrows(TypeConverterException.class, () -> {
    ...
    public void testExtractDoubleFromString() {
        ...
        assertAll(
                ...
                () -> {
                    TypeConverterException ex = assertThrows(TypeConverterException.class, () -> extractDoubleFromString(null),"A null string must throw an exception");
                    dbg(logger, "TypeConverterException : {}", ex.getMessage());
                },
                () -> {
                    TypeConverterException ex = assertThrows(TypeConverterException.class, () -> {
                    ...
                    },"A string with only blank characters must throw an exception");
                    dbg(logger, "TypeConverterException : {}", ex.getMessage());
                },
                () -> {
                    TypeConverterException ex = assertThrows(TypeConverterException.class, () -> {
                        ...
                        extractDoubleFromString(theString);
                    },"A string that does not contain a double value must throw an exception");
                    dbg(logger, "TypeConverterException : {}", ex.getMessage());
                }
        );
    }
