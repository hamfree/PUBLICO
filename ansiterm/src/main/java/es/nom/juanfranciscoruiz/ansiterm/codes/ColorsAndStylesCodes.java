...
public class ColorsAndStylesCodes {
    ...
    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(ColorsAndStylesCodes.class);
    /**
     * Singleton instance of the {@code ColorsAndStylesCodes} class.
     ...
     */
    private static final ColorsAndStylesCodes INSTANCE;

    static {
        INSTANCE = new ColorsAndStylesCodes();
    ...
    /**
     * Returns the current instance of the ColorsAndStylesCodes class.
     *
     * @return the existing instance of ColorsAndStylesCodes.
     */
    public static ColorsAndStylesCodes getInstance() {
        return INSTANCE;
    }
